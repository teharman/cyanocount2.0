...
#Compile 20X Data
Main_Shape_Data[nrow(Main_Shape_Data) + 1, ] <- c('Microcystis','F108','20X','Area',cell_area_avg,cell_area_std,cell_area_1QR,cell_area_3QR)
Main_Shape_Data[nrow(Main_Shape_Data) + 1, ] <- c('Microcystis','F108','20X','Perimeter',cell_peri_avg,cell_peri_std,cell_peri_1QR,cell_peri_3QR)
Main_Shape_Data[nrow(Main_Shape_Data) + 1, ] <- c('Microcystis','F108','20X','Radius',cell_radius_avg,cell_radius_std,cell_radius_1QR,cell_radius_3QR)

rm(list = setdiff(ls(),c("Main_Shape_Data")))

####Dolichospermum_F199 20X Data####
...
#Compile 20X Data
Main_Shape_Data[nrow(Main_Shape_Data) + 1, ] <- c('Dolichospermum','F199','20X','Area',cell_area_avg,cell_area_std,cell_area_1QR,cell_area_3QR)
Main_Shape_Data[nrow(Main_Shape_Data) + 1, ] <- c('Dolichospermum','F199','20X','Perimeter',cell_peri_avg,cell_peri_std,cell_peri_1QR,cell_peri_3QR)
Main_Shape_Data[nrow(Main_Shape_Data) + 1, ] <- c('Dolichospermum','F199','20X','Radius',cell_radius_avg,cell_radius_std,cell_radius_1QR,cell_radius_3QR)
