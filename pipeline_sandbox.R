...
server_main = function(input, output, session) {
  ...
  observeEvent(input$run3,{
    message("applying binary segmentation - please wait")
    ...
    beepr::beep(sound=1)
    message("***segmentation applied***")
  })
  observeEvent(input$update3,{
    message("loading ID prediction model - please wait")
    ...
    message("***ID prediction complete***")
    beepr::beep(sound=1)
  })
